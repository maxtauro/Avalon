...
class HostLobbyActivity : AppCompatActivity() {
    ...
    private fun setupGame() {
        ...
        val gameId = AvalonGameModel.generateRandomId()
        gameHelper = FirebaseGameHelperImpl(gameId)

        gameHelper.createGame(hostName)
        gameHelper.joinGame(hostName)
    }

    companion object {
        private const val TAG = "HostLobbyActivity"
    }
}